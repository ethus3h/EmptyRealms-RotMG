...
namespace wServer.logic
{
    public class DamageCounter
    {
        ...
        public NPC LastHitterNPC { get; private set; }
        public Character LastHitterChar { get; private set; }
        ...
        WeakDictionary<NPC, int> NPChitters = new WeakDictionary<NPC, int>();
        ...
        public void HitBy(Player player, Projectile projectile, int dmg)
        {
            ...
            LastHitter = player;
            LastHitterChar = player as Character;
        ...
        public void Death()
        {
            ...
            if (enemy.Owner is GameWorld)
                (enemy.Owner as GameWorld).EnemyKilled(enemy, (Parent ?? this).LastHitterChar);
        }
    }
}
