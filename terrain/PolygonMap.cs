...
namespace terrain
{
    ...
    class PolygonMap
    {
        ...
        public IGeometryCollection VoronoiDiagram
        {
            get;
            private set;
        }
        ...
        static IGeometryCollection ClipGeometryCollection(IGeometryCollection geom, Envelope clipEnv)
        {
            ...
            for (int i = 0; i < geom.NumGeometries; i++)
            {
                ...
                if (clipEnv.Contains(g.EnvelopeInternal)) result = g;
        ...
        void FindOceans() {
            ...
            foreach(var i in waters) {
                if (i.X == -1 || i.X == 1 || i.Y == -1 || i.Y == 1 || i.IsOcean || i.Edges.Select(_ => _.To).All(_ => _.IsWater)) {
                    i.IsOcean = true;
                    continue;
                }
                ...
                do {
                    ...
                    foreach(var j in current.Edges) {
                        ...
                        if (j.To.X == -1 || j.To.X == 1 || j.To.Y == -1 || j.To.Y == 1) {
                            isOcean = true;
                            q.Clear();
                            break;
                        }
        ...
        void FindLakesAndCoasts() {
            ...
            do {
                ...
                if (i.IsWater && lake.Contains(i)) {
                    if (i.Neighbour.Any(_ => !_.IsWater)) coast.Add(i);
                    lake.Remove(i);
                    q.Enqueue(i);
                }
            } while (q.Count > 0);
        ...
        void ComputeDistances() {
            ...
            do {
                ...
                foreach(var i in n.Edges) {
                    ...
                    if (d > dist + 1) d = dist + 1;
                    i.To.DistanceToCoast = d;

                    if (!visited.Contains(i.To)) queue.Enqueue(i.To);
                }
            } while (queue.Count > 0);
        }
            ...
            PlanarGraph graph; {
                ...
                for (int i = 0; i < VoronoiDiagram.Count; i++) {
                    ...
                    for (int j = 1; j < coords.Length; j++) {
                        edges.Add(new Edge(new Coordinate[] {
                            coords[j - 1], coords[j]
                        }, new Label(Location.Boundary)));
                    }
                }
            ...
            Dictionary < Node, MapNode > nodeDict; {
                ...
                for (int i = 0; i < VoronoiDiagram.Count; i++) {
                    ...
                    foreach(var j in VoronoiDiagram[i].Coordinates.Skip(1)) {
                        ...
                        } else dats[mapNode].Item1.Add(poly);
