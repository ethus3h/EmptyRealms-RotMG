...
public class FameStats {
    ...
    public int CalculateTotal(Account acc, Char chr, int baseFame, out bool firstBorn) {
        ...
        #endregion
        #region Tunnel Rat
        if (PirateCavesCompleted > 0 && UndeadLairsCompleted > 0 && AbyssOfDemonsCompleted > 0 && SnakePitsCompleted > 0 && SpiderDensCompleted > 0 && SpriteWorldsCompleted > 0 && TombsCompleted > 0 && TrenchesCompleted > 0 && JunglesCompleted > 0 && ManorsCompleted > 0) {
    ...
    void SerializeBonus(XmlDocument doc, Account acc, Char chr, int baseFame, bool firstBorn) {
        ...
        if (PirateCavesCompleted > 0 && UndeadLairsCompleted > 0 && AbyssOfDemonsCompleted > 0 && SnakePitsCompleted > 0 && SpiderDensCompleted > 0 && SpriteWorldsCompleted > 0 && TombsCompleted > 0 && TrenchesCompleted > 0 && JunglesCompleted > 0 && ManorsCompleted > 0) //Tunnel Rat
        {
            XmlElement x = doc.CreateElement("Bonus");
            XmlAttribute idAttr = doc.CreateAttribute("id");
