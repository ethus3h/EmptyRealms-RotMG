...
public class Account
{
    ...
    public bool NameChosen
    {
        get
        {
            return this._NameChosen != null;
        }
        set
        {
            this._NameChosen = value ? "True" : null;
        }
    }

    [XmlElement("Converted")]
    public string _Converted
    {
        get;
        set;
    }
    ...
    public bool Converted
    {
        get
        {
            return this._Converted != null;
        }
        set
        {
            this._Converted = value ? "True" : null;
        }
    }
    ...
    public bool Admin
    {
        ...
        set
        {
            this._Admin = value ? "True" : null;
        }
    }

    [XmlElement("Banned")]
    public string _Banned
    {
        get;
        set;
    }
    ...
    public bool Banned
    {
        get
        {
            return this._Banned != null;
        }
        set
        {
            this._Banned = value ? "True" : null;
        }
    }
    ...
    public bool VerifiedEmail
    {
        get
        {
            return this._VerifiedEmail != null;
        }
        set
        {
            this._VerifiedEmail = value ? "True" : null;
        }
    }

    [XmlElement("StarredAccounts")]
    public string _StarredAccounts
    {
        get;
        set;
    }
    ...
    public List<int> Locked
    {
        get
        {
            return (this._StarredAccounts != null ? Utils.StringListToIntList(this._StarredAccounts.Split(',').ToList()) : new List<int>());
        }
        set
        {
            this._StarredAccounts = string.Join(",", value);
        }
    }

    [XmlElement("IgnoredAccounts")]
    public string _IgnoredAccounts
    {
        get;
        set;
    }
    ...
    public List<int> Ignored
    {
        get
        {
            return (this._IgnoredAccounts != null ? Utils.StringListToIntList(this._IgnoredAccounts.Split(',').ToList()) : new List<int>());
        }
        set
        {
            this._IgnoredAccounts = string.Join(",", value);
        }
    }
...
public class VaultChest
{
    ...
    public int[] Items
    {
        get
        {
            return Utils.FromCommaSepString32(_Items);
        }
        set
        {
            _Items = Utils.GetCommaSepString(value);
        }
    }
}
[Serializable, XmlRoot()]
...
public class ServerItem
{
    ...
    public bool AdminOnly
    {
        get
        {
            return this._AdminOnly != null;
        }
        set
        {
            this._AdminOnly = value ? "True" : null;
        }
    }
}
...
public class Char
{
    ...
    public short[] Equipment
    {
        get
        {
            return Utils.FromCommaSepString16(_Equipment);
        }
        set
        {
