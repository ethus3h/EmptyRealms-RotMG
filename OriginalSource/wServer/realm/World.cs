...
namespace wServer.realm
{
    public abstract class World
    {
        ...
        public ConcurrentDictionary<int, NPC> NPCs { get; private set; }
        ...
        public CollisionMap<Entity> ProjectilesCollision { get; private set; }
        ...
        public virtual void LeaveWorld(Entity entity)
        {
            ...
            else if (entity is NPC)
            {
                ...
                NPCs.TryRemove(entity.Id, out dummy2);
                if (entity.ObjectDesc.Enemy)
            ...
            else if (entity is Projectile)
            {
                ...
                ProjectilesCollision.Remove(entity);
            }
            else if (entity is StaticObject)
            {
                StaticObject dummy;
        ...
        public virtual void Tick(RealmTime time)
        {
            ...
            {
                foreach (var i in EnemiesCollision.GetActiveChunks(PlayersCollision).Where(x => !(x is NPC)))
                    i.Tick(time);
