...
namespace wServer.realm.entities
{
    ...
    public class ConnectionInfo
    {
        ...
        {
            Build(0x02020202, ConnectionType.Dot);
            Build(0x01020202, ConnectionType.ShortLine);
            Build(0x01010202, ConnectionType.L);
            Build(0x01020102, ConnectionType.Line);
            Build(0x01010201, ConnectionType.T);
            Build(0x01010101, ConnectionType.Cross);
        }
